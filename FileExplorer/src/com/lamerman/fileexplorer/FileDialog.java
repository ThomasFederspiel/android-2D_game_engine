package com.lamerman.fileexplorer;
 ...
 * 
 */
public class FileDialog extends Activity implements OnItemClickListener 
{
	...
	public static final String SELECT_FILE_DIRECT = "SELECT_FILE_DIRECT";
	
	public static final String BACK_BUTTON_REVERSE = "BACK_BUTTON_REVERSE";
	...
	private boolean selectFileDirect = false;
	private boolean backButtonReverse = false;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mListView = (ListView) findViewById(R.id.fdList);
		...
		backButtonReverse = getIntent().getBooleanExtra(BACK_BUTTON_REVERSE, false);
		
		selectFileDirect = getIntent().getBooleanExtra(SELECT_FILE_DIRECT, false);
		...
		if (selectionMode == SelectionMode.MODE_CREATE)
		{
	...
	private void selectEnabled(boolean enable)
	{
		if (!selectFileDirect)
		{
	...
	private void newEnabled(boolean enable)
	{
		if (selectionMode == SelectionMode.MODE_CREATE)
		{
